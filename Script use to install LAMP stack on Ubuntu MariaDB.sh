#!/bin/bash
# Script author: David Sairai
# Script site: https://www.davidsairai.com
# Script date: 02-01-2020
# Script ver: 1.1
# Script use to install LAMP stack on Ubuntu 18.x
#--------------------------------------------------
# Software version:
# 1. OS: Ubuntu Ubuntu 18 LTS 64bit
# 2. Apache: 2.4.18
# 3. MariaDB: 10.0.34
